export const menuItems = [
    ...
    },
    {
        ...
        isHide: true,
        icon: "bx:data",
        link: route("list.entries") || "list/entry",
        link2: "list/entry",
    },
    {
        title: "Posting",
        isHide: true,
        icon: "stash:paperplane",
        link: route("list.postings") || "list/postings",
        link2: "list/postings",
    },
    {
        title: "Laporan",
    ...
    },
    {
        ...
        link: route("list.close.book") || "list/close-book",
        link2: "list/close-book",
    },
    {
        isHeadr: true,
        title: "Master Data",
    },
    {
        ...
        child: [
            {
                childtitle: "Group Perkiraan",
                childlink: route("list.coa"),
                link: "master/coa",
            },
            {
                childtitle: "Akun",
                childlink: route("list.accounts"),
                link: "master/accounts",
            },
            {
                childtitle: "Ledgers",
                childlink: route("list.ledgers"),
                link: "master/ledgers",
            },
            {
                childtitle: "Lokasi",
                childlink: route("list.locations"),
                link: "master/list-locations",
            },
            {
                childtitle: "Laba Rugi",
    ...
    },
    {
        ...
        isHide: true,
        icon: "mdi:user",
        link: route("list.users") || "list-users",
        link2: "list-users",
    },
    // {
    //     title: "Settings",
    ...
    //         {
    //             childtitle: "User",
    //             childlink: route("list.user"),
    //             link: "list-user",
    //             permission: "read_user_list",
    //         },
    //         {
    //             childtitle: "Department",
    //             childlink: route("list.department"),
    //             link: "master/list-department",
    //             permission: "read_master_department",
    //         },
    //         {
    //             childtitle: "Position",
    //             childlink: route("list.position"),
    //             link: "master/list-position",
    //             permission: "read_master_position",
    //         },
    //     ],
    // },
