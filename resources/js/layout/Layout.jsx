...
import ModalChangePassword from "@/components/ui/Modal/ModalChangePassword";
import { initialPermissionLists } from "@/context/permissionUser";
...
const Layout = ({ children }) => {
    ...
    initialPermissionLists(auth?.user?.permissions);
    ...
    useEffect(() => {
        if (auth?.user?.password_reset_at) {
