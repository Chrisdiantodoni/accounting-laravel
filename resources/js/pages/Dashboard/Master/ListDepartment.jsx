...
import ModalAddDepartment from "@/components/ui/Modal/ModalAddDepartment";
...
export default function ListDepartment() {
    ...
    const { filters, departments } = usePage().props;
    ...
    return (
        <Card
            ...
            headerslot={
                hasPermission("add_master_department") && (
                    <Button
                        text={"Add New Department"}
                        className="btn-dark"
                        onClick={() => handleModal("modalAddDepartment", true)}
                    />
                )
            }
            noborder
                ...
                <div className="grid grid-cols-12 gap-6">
                    ...
                    <div className="col-span-12">
                        <Pagination
                            ...
                            currentPageItems={departments?.data?.length}
                            totalPages={departments?.last_page}
                            totalItems={departments?.per_page}
