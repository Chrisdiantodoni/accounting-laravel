...
import ModalAddLocation from "@/components/ui/Modal/ModalAddLocation";
...
function ListLocation() {
    const { filters, locations } = usePage().props;
                ...
                <div className="grid grid-cols-12 gap-6">
                    ...
                    <div className="col-span-12">
                        <Pagination
                            ...
                            currentPageItems={locations?.data?.length}
                            totalPages={locations?.last_page}
                            totalItems={locations?.per_page}
